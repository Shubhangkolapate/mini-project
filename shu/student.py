...
#====================BUTTONS===============
        btn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),bg="#00B2EE",fg="black").place(x=50,y=270,width=110,height=28)
...
#=============student details=============
        ...
        student_frame.place(x=0,y=320,relwidth=1,height=150)
